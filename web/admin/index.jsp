<%-- 
    Document   : index
    Created on : 05/06/2012, 6:24:46 PM
    Author     : dinesh
--%>
        ...
        <c:forEach var="customer" items="${customerList}" varStatus="iter">
            ...
            <tr class="${((iter.index % 2) == 1) ? 'lightBlue' : 'white'} tableRow"
              ...
              <%-- Below anchor tags are provided in case JavaScript is disabled --%>
                ...
                <td><a href="customerRecord?${customer.id}" class="noDecoration">${customer.address}</a></td>
                <td><a href="customerRecord?${customer.id}" class="noDecoration">${customer.cityRegion}</a></td>
                <td><a href="customerRecord?${customer.id}" class="noDecoration">${customer.ccNumber}</a></td>
            </tr>
        ...
        <c:forEach var="order" items="${orderList}" varStatus="iter">
            ...
            <tr class="${((iter.index % 2) == 1) ? 'lightBlue' : 'white'} tableRow"
              ...
              <%-- Below anchor tags are provided in case JavaScript is disabled --%>
                ...
                <td><a href="orderRecord?${order.id}" class="noDecoration">${order.conformationNumber}</a></td>
...
<c:if test="${!empty orderRecord}">
    ...
    <table id="adminTable" class="detailsTable">
        ...
        <tr>
            ...
            <td>${orderRecord.conformationNumber}</td>
        </tr>
        <tr>
